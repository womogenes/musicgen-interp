...
def main():
    ...
    RESULTS_ROOT = Path("results_sweep_last4")
    ...
    # ---- ONLY THESE FOUR LAYERS ----
    target_indices = {36, 40, 44, 47}
    selected_layers = [name for idx, name in indexed_layers if idx in target_indices]
